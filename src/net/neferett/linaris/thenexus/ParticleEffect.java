...
import net.neferett.linaris.thenexus.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
     ...
     */
    private ParticleEffect(final String name, final int id, final int requiredVersion, final boolean requiresData, final boolean requiresWater) {
        this.name = name;
        this.id = id;
     ...
     */
    private ParticleEffect(final String name, final int id, final int requiredVersion, final boolean requiresData) {
    ...
    public static ParticleEffect fromName(final String name) {
        for (final Entry<String, ParticleEffect> entry : ParticleEffect.NAME_MAP.entrySet()) {
    ...
    public static ParticleEffect fromId(final int id) {
        for (final Entry<Integer, ParticleEffect> entry : ParticleEffect.ID_MAP.entrySet()) {
            if (entry.getKey() != id) {
                continue;
            }
            return entry.getValue();
     ...
     */
    public void display(final Location center, final double range) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        if (!this.isSupported()) { throw new ParticleVersionException("This particle effect is not supported by your server version"); }
        if (requiresData) { throw new ParticleDataException("This particle effect requires additional data"); }
        if (requiresWater && !ParticleEffect.isWater(center)) { throw new IllegalArgumentException("There is no water at the center location"); }
        new ParticlePacket(this, 0, 0, 0, 0, 1, range > 256, null).sendTo(center, range);
    }
     ...
     * @see ParticlePacket#sendTo(Location, double)
     */
    public void display(final Location center, final float offsetX, final float offsetY, final float offsetZ, final float speed, final int amount) throws ParticleVersionException, ParticleDataException, IllegalArgumentException {
        if (!this.isSupported()) { throw new ParticleVersionException("This particle effect is not supported by your server version"); }
        if (requiresData) { throw new ParticleDataException("This particle effect requires additional data"); }
        if (requiresWater && !ParticleEffect.isWater(center)) { throw new IllegalArgumentException("There is no water at the center location"); }
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed, amount, false, null).sendTo(center, 16);
    }
    ...
    public void display(final ParticleData data, final float offsetX, final float offsetY, final float offsetZ, final float speed, final int amount, final Location center, final double range) throws ParticleVersionException, ParticleDataException {
        if (!this.isSupported()) { throw new ParticleVersionException("This particle effect is not supported by your server version"); }
        if (!requiresData) { throw new ParticleDataException("This particle effect does not require additional data"); }
    ...
    public static final class ParticlePacket {
        ...
        public ParticlePacket(final ParticleEffect effect, final float offsetX, final float offsetY, final float offsetZ, final float speed, final int amount, final boolean longDistance, final ParticleData data) throws IllegalArgumentException {
            ...
            if (amount < 1) { throw new IllegalArgumentException("The amount is lower than 1"); }
            this.effect = effect;
        ...
        public ParticlePacket(final ParticleEffect effect, final Vector direction, final float speed, final boolean longDistance, final ParticleData data) throws IllegalArgumentException {
            ...
            if (speed < 0) { throw new IllegalArgumentException("The speed is lower than 0"); }
            this.effect = effect;
            offsetX = (float) direction.getX();
            offsetY = (float) direction.getY();
            offsetZ = (float) direction.getZ();
            this.speed = speed;
            amount = 0;
            this.longDistance = longDistance;
            this.data = data;
        ...
        public static void initialize() throws VersionIncompatibleException {
            if (ParticlePacket.initialized) { return; }
            try {
                ...
                final Class<?> packetClass = PackageType.MINECRAFT_SERVER.getClass(ParticlePacket.version < 7 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
                ...
                ParticlePacket.playerConnection = ReflectionUtils.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                ParticlePacket.sendPacket = ReflectionUtils.getMethod(ParticlePacket.playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
        ...
        public void sendTo(final Location center, final Player player) throws PacketInstantiationException, PacketSendingException {
            if (packet == null) {
                try {
                    packet = ParticlePacket.packetConstructor.newInstance();
                    Object id;
                    if (ParticlePacket.version < 8) {
                        ...
                        id = ParticlePacket.enumParticle.getEnumConstants()[effect.getId()];
                    }
            ...
            try {
                ParticlePacket.sendPacket.invoke(ParticlePacket.playerConnection.get(ParticlePacket.getHandle.invoke(player)), packet);
            } catch (final Exception exception) {
        ...
        public void sendTo(final Location center, final List<Player> players) throws IllegalArgumentException {
            if (players.isEmpty()) { throw new IllegalArgumentException("The player list is empty"); }
            for (final Player player : players) {
        ...
        public void sendTo(final Location center, final double range) throws IllegalArgumentException {
            if (range < 1) { throw new IllegalArgumentException("The range is lower than 1"); }
