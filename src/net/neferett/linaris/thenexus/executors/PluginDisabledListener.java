...
class PluginDisabledListener implements Listener {
    ...
    private final Set<Future<?>> futures = Collections.newSetFromMap(new WeakHashMap<Future<?>, Boolean>());
    private final Set<ExecutorService> services = Collections.newSetFromMap(new WeakHashMap<ExecutorService, Boolean>());
