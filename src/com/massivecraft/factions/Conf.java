...
public class Conf {
    ...
    public static String dbName = "thenexus";
    ...
    static {
        Conf.baseCommandAliases.add("f");

        Conf.territoryEnemyDenyCommands.add("home");
        Conf.territoryEnemyDenyCommands.add("sethome");
        Conf.territoryEnemyDenyCommands.add("spawn");
        Conf.territoryEnemyDenyCommands.add("tpahere");
        Conf.territoryEnemyDenyCommands.add("tpaccept");
        Conf.territoryEnemyDenyCommands.add("tpa");

        Conf.territoryProtectedMaterials.add(Material.WOODEN_DOOR);
        Conf.territoryProtectedMaterials.add(Material.TRAP_DOOR);
        Conf.territoryProtectedMaterials.add(Material.FENCE_GATE);
        Conf.territoryProtectedMaterials.add(Material.DISPENSER);
        Conf.territoryProtectedMaterials.add(Material.CHEST);
        Conf.territoryProtectedMaterials.add(Material.FURNACE);
        Conf.territoryProtectedMaterials.add(Material.BURNING_FURNACE);
        Conf.territoryProtectedMaterials.add(Material.DIODE_BLOCK_OFF);
        Conf.territoryProtectedMaterials.add(Material.DIODE_BLOCK_ON);
        Conf.territoryProtectedMaterials.add(Material.JUKEBOX);
        Conf.territoryProtectedMaterials.add(Material.BREWING_STAND);
        Conf.territoryProtectedMaterials.add(Material.ENCHANTMENT_TABLE);
        Conf.territoryProtectedMaterials.add(Material.CAULDRON);
        Conf.territoryProtectedMaterials.add(Material.SOIL);
        Conf.territoryProtectedMaterials.add(Material.BEACON);
        Conf.territoryProtectedMaterials.add(Material.ANVIL);
        Conf.territoryProtectedMaterials.add(Material.TRAPPED_CHEST);
        Conf.territoryProtectedMaterials.add(Material.DROPPER);
        Conf.territoryProtectedMaterials.add(Material.HOPPER);

        Conf.territoryDenyUseageMaterials.add(Material.FIREBALL);
        Conf.territoryDenyUseageMaterials.add(Material.FLINT_AND_STEEL);
        Conf.territoryDenyUseageMaterials.add(Material.BUCKET);
        Conf.territoryDenyUseageMaterials.add(Material.WATER_BUCKET);
        Conf.territoryDenyUseageMaterials.add(Material.LAVA_BUCKET);

        Conf.territoryProtectedMaterialsWhenOffline.add(Material.WOODEN_DOOR);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.TRAP_DOOR);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.FENCE_GATE);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.DISPENSER);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.CHEST);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.FURNACE);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.BURNING_FURNACE);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.DIODE_BLOCK_OFF);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.DIODE_BLOCK_ON);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.JUKEBOX);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.BREWING_STAND);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.ENCHANTMENT_TABLE);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.CAULDRON);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.SOIL);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.BEACON);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.ANVIL);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.TRAPPED_CHEST);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.DROPPER);
        Conf.territoryProtectedMaterialsWhenOffline.add(Material.HOPPER);

        Conf.territoryDenyUseageMaterialsWhenOffline.add(Material.FIREBALL);
        Conf.territoryDenyUseageMaterialsWhenOffline.add(Material.FLINT_AND_STEEL);
        Conf.territoryDenyUseageMaterialsWhenOffline.add(Material.BUCKET);
        Conf.territoryDenyUseageMaterialsWhenOffline.add(Material.WATER_BUCKET);
        Conf.territoryDenyUseageMaterialsWhenOffline.add(Material.LAVA_BUCKET);

        Conf.safeZoneNerfedCreatureTypes.add(EntityType.BLAZE);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.CAVE_SPIDER);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.CREEPER);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.ENDER_DRAGON);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.ENDERMAN);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.GHAST);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.MAGMA_CUBE);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.PIG_ZOMBIE);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.SILVERFISH);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.SKELETON);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.SPIDER);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.SLIME);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.WITCH);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.WITHER);
        Conf.safeZoneNerfedCreatureTypes.add(EntityType.ZOMBIE);
    }
    ...
    public static void load() {
        P.p.persist.loadOrSaveDefault(Conf.i, Conf.class, "conf");
    }

    public static void save() {
        P.p.persist.save(Conf.i);
    }
}
