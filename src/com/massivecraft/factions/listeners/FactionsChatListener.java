...
public class FactionsChatListener implements Listener {
    ...
    public void onPlayerEarlyChat(final PlayerChatEvent event) {
        ...
        final FPlayer me = FPlayers.i.get(talkingPlayer);
        ...
        if (chat == ChatMode.FACTION) {
            ...
            final String message = String.format(Conf.factionChatFormat, me.describeTo(myFaction), msg);
    ...
    public void onPlayerChat(final PlayerChatEvent event) {
        ...
        if (!Conf.chatTagReplaceString.isEmpty() && eventFormat.contains(Conf.chatTagReplaceString)) {
            ...
            // The Nexus Start
            if (eventFormat.contains("[FACTION_LEVEL]")) {
                final Faction faction = me.getFaction();
                eventFormat = eventFormat.replace("[FACTION_LEVEL]", faction.isNormal() ? String.valueOf(faction.getLevel().getId()) : "");
            }
            // The Nexus End
        ...
        if (Conf.chatTagRelationColored) {
            ...
            for (final Player listeningPlayer : event.getRecipients()) {
                final FPlayer you = FPlayers.i.get(listeningPlayer);
